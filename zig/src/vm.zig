...
//!   vm/streams.zig  — string-stream registry + stream I/O prims — M1
//!   vm/marshal.zig  — C Value <-> Shen tagged-form marshalling — M2
//!   vm/hostcall.zig — host-side calls into bundled closures — M2
//!   vm/execplan.zig — exec-plan process runner + process prims — M3

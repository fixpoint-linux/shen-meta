 ...
 * N=1050 symbols, minimal-perfect-hash: index=(h(name,H1)%N + g[h(name,H2)%350])%N.
 */
#ifndef SYMBOL_STATIC_H
#define SYMBOL_STATIC_H

#define SYMBOL_STATIC_N 1050
#define SYMBOL_STATIC_M 350
#define SYMBOL_STATIC_H1 0x9E3779B9u
#define SYMBOL_STATIC_H2 0x0000000Bu

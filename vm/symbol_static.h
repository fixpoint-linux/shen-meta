 ...
 * N=1111 symbols, minimal-perfect-hash: index=(h(name,H1)%N + g[h(name,H2)%370])%N.
 */
#ifndef SYMBOL_STATIC_H
#define SYMBOL_STATIC_H

#define SYMBOL_STATIC_N 1111
#define SYMBOL_STATIC_M 370
#define SYMBOL_STATIC_H1 0x00000001u
#define SYMBOL_STATIC_H2 0xC2B2AE35u
